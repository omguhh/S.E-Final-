...
--
-- Host: localhost
-- Generation Time: Apr 05, 2015 at 09:17 PM
...
('aclient', 'clientdude', 'clientdude@email.com', '69th street, 4th floor, 2nd appartment, 0', 81981203, 383996, 'sonia santa', 1004, 'client123'),
...
('sm75', 'shoaib mawani', 'sm143@live.com', 'Nahda', 50505869, 1, 'hakim moti', 1000, 'shoaib123');
...
INSERT INTO `stocks` (`stock_name`, `stock_price`, `fa_name`, `client_name`, `date_bookmarked`) VALUES
('airware', 58, 'sonia santa', 'clientdude', '2015-02-28'),
('apple', 91, 'Mohammed Shaath', 'naiyarah hussain', '2015-02-28');
...
--
ALTER TABLE `stocks`
  ADD CONSTRAINT `stocks_ibfk_2` FOREIGN KEY (`client_name`) REFERENCES `registered_client` (`rc_name`),
