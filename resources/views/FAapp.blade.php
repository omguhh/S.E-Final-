...
<head>
    ...
    <!-- iCheck -->
    <link href="http://localhost/I'mDoneWithSE/S.E-Final-/resources/assets/Plugins/blue.css" rel="stylesheet" type="text/css" />
    <!-- Morris chart -->
    ...
    <!--[if lt IE 9]>
    <script src="http://localhost/I'mDoneWithSE/S.E-Final-/public/js/html5shiv.js"></script>
    <script src="http://localhost/I'mDoneWithSE/S.E-Final-/public/js/respond.min.js"></script>
    <![endif]-->
</head>
...
<!-- jQuery UI 1.11.2 -->
<script src="http://localhost/I'mDoneWithSE/S.E-Final-/public/js/jquery-ui.min.js" type="text/javascript"></script>
<!-- Resolve conflict in jQuery UI tooltip with Bootstrap tooltip -->
<script>
    $.widget.bridge('uibutton', $.ui.button);
</script>
<!-- Bootstrap 3.3.2 JS -->
<script src="http://localhost/I'mDoneWithSE/S.E-Final-/public/css/bootstrap.min.css" type="text/javascript"></script>
<!-- Morris.js charts -->
<script src="http://localhost/I'mDoneWithSE/S.E-Final-/public/js/raphael-min.js"></script>
